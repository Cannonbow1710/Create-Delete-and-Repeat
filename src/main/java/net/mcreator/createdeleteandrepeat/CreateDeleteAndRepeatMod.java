package net.mcreator.createdeleteandrepeat;
...
@Mod("create_delete_and_repeat")
public class CreateDeleteAndRepeatMod {
	public static final Logger LOGGER = LogManager.getLogger(CreateDeleteAndRepeatMod.class);
	public static final String MODID = "create_delete_and_repeat";

	public CreateDeleteAndRepeatMod(IEventBus modEventBus) {
