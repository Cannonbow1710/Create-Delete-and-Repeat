...
@EventBusSubscriber
public class IndustrialCauldronBurnProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == CreateDeleteAndRepeatModBlocks.INDUSTRIAL_CAULDRON.get()
